...
export const mockNewsData: NewsData[] = [
  {
    ...
    contents: [
      {
        imageUrl: "/images/News-1-1.png",
        content: `Trong lòng thành phố náo nhiệt, nơi mà những tiếng ồn ào của cuộc sống hiện đại dường như không bao giờ dứt, có một nơi mà cuộc sống thịnh vượng và an lành đang chờ đón bạn. Đó chính là Vlasta Thủy Nguyên – một kiệt tác kiến trúc và môi trường sống lý tưởng, nơi mà con người có thể tìm thấy sự cân bằng hoàn hảo giữa hiện đại và thiên nhiên.\n
      ...
      {
        imageUrl: "/images/News-1-2.png",
        content: `Một trong những điểm nhấn nổi bật của Vlasta Thuỷ Nguyên chính là hệ thống tiện ích đa dạng và hiện đại. Từ các khu vui chơi giải trí, hồ bơi, công viên cây xanh cho đến các trung tâm thương mại, tất cả đều được bố trí hợp lý và thuận tiện, đáp ứng mọi nhu cầu của cư dân. Đây không chỉ là nơi để sống, mà còn là nơi để thư giãn, tận hưởng và kết nối cộng đồng.\n
      ...
      {
        imageUrl: "/images/News-1-3.png",
        content: `Không chỉ dừng lại ở đó, Vlasta Thủy Nguyên còn mang đến một môi trường giáo dục và y tế chất lượng cao. Các trường học và bệnh viện uy tín được tích hợp trong khu vực, giúp cư dân tiết kiệm thời gian di chuyển và yên tâm về sức khỏe cũng như giáo dục của con em mình. Đây chính là nền tảng vững chắc cho một cuộc sống thịnh vượng và an lành.\n
  ...
  {
    id: 2,
    title: "Cập nhật tiến độ Dự án Jade Lake Residence – Tây Thăng Long",
    type: "style",
    date: "21 Tháng 2, 2025",
    author: "Admin",
    contents: [
      {
        imageUrl: "/images/News-2-Process-0.png",
        content:
      ...
      },
      {
        images: [
          {
            imageUrl: "/images/News-2-Process-1.png",
          },
          {
            imageUrl: "/images/News-2-Process-2.png",
          },
          {
            imageUrl: "/images/News-2-Process-3.png",
          },
          {
            imageUrl: "/images/News-2-Process-4.png",
          },
          {
            imageUrl: "/images/News-2-Process-5.png",
          },
          {
            imageUrl: "/images/News-2-Process-6.png",
          },
          {
            imageUrl: "/images/News-2-Process-7.png",
          },
          {
            imageUrl: "/images/News-2-Process-8.png",
          },
          {
            imageUrl: "/images/News-2-Process-9.png",
          },
          {
            imageUrl: "/images/News-2-Process-10.png",
          },
          {
            imageUrl: "/images/News-2-Process-11.png",
          },
          {
            imageUrl: "/images/News-2-Process-12.png",
          },
          {
            imageUrl: "/images/News-2-Process-13.png",
          },
          {
            imageUrl: "/images/News-2-Process-14.png",
          },
          {
            imageUrl: "/images/News-2-Process-15.png",
          },
          {
            imageUrl: "/images/News-2-Process-16.png",
          },
          {
            imageUrl: "/images/News-2-Process-17.png",
          },
          {
            imageUrl: "/images/News-2-Process-18.png",
          },
          {
            imageUrl: "/images/News-2-Process-19.png",
          },
          {
            imageUrl: "/images/News-2-Process-20.png",
          },
        ],
      },
    ],
